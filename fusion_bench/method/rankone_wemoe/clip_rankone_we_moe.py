...
from .rankone_we_moe import RankOneWeightEnsemblingMoEAlgorithm

log = logging.getLogger(__name__)


class CLIPRankOneWeightEnsemblingMoEAlgorithm(
    RankOneWeightEnsemblingMoEAlgorithm,
    CLIPClassificationMixin,
):
    """
    CLIPRankOneWeightEnsemblingMoEAlgorithm is a class that implements the RankOneWeightEnsemblingMoEAlgorithm
    for CLIP models. It extends the RankOneWeightEnsemblingMoEAlgorithm and CLIPClassificationMixin classes.
    ...
    def construct_moe_model(self) -> RankOneWeightEnsemblingMoE:
        """
        Construct the Mixture of Experts (MoE) model using the models in the model pool.

        Returns:
            RankOneWeightEnsemblingMoE: The constructed MoE model.
        """
        ...
        for layer_idx in range(num_layers):
            ...
            moe_encoder.layers[layer_idx].mlp = RankOneWeightEnsemblingMoE(
