...
from fusion_bench.models.rankone_moe.rankone_moe_linear import RankOne_MoELinear
...
class RankOneUpscalingAlgorithm(
    SimpleProfilerMixin,
    BaseAlgorithm,
):
    ...
    _config_mapping = BaseAlgorithm._config_mapping | {
        ...
        "expert_use_diff": "expert_use_diff",
        "joint_svd": "joint_svd",
    ...
    def __init__(
        ...
        *,
        ...
        expert_use_diff: bool = True,
        joint_svd: bool = False,
        average_experts: bool = False,
        model_path: str = None,
        **kwargs,
    ):
        """
        Initialize the RankOneUpscalingAlgorithm.
    ...
    def _upscale_linear_layer(
        ...
        try:
            moe_linear = RankOne_MoELinear(
                module,
                experts,
                k=config.k,
                top_k=config.top_k,
                routing_use_diff=self.routing_use_diff,
                expert_use_diff=self.expert_use_diff,
                joint_svd=self.joint_svd,
